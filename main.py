# Library used (uvicorn[standard] , fastapi , python-multipart , python-jose[cryptography] , passlib[bcrypt])
# to run     uvicorn main:app --reload
# main is file name, app is variable
# /docs brings inbuilt swagger for fastapi for testing
# JWT = Jason Web Token
...
SECERET_KEY = "83daa0256a2289b0fb23693bf1f6034d44396675749244721a2b20e896e11662"
ALGORITHM = "HS256"
